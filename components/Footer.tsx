    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-xl font-bold text-white mb-6 border-b border-gray-700 pb-2 inline-block">Hızlı Bağlantılar</h3>
          ...
          <div>
            <h3 className="text-xl font-bold text-white mb-6 border-b border-gray-700 pb-2 inline-block">İletişim</h3>
            <div className="space-y-4 text-sm">
              ...
              <p className="flex items-center gap-3">
                ...
                <a href="tel:+905322830628" className="hover:text-white transition-colors">0532 283 0628</a>
              </p>
              <p className="flex items-center gap-3">
