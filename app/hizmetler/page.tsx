...
export const metadata: Metadata = {
  title: "Kurumsal Lojistik Hizmetleri | Evden Eve Nakliyat",
  description: "Evden eve nakliyat, kurumsal ofis taşımacılığı, eşya depolama ve araç lojistiği alanlarında sunduğumuz profesyonel hizmetler.",
};
