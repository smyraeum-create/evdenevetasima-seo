...
const serviceData: Record<string, any> = {
  "evden-eve-nakliyat": {
    ...
    images: [
      "/images/hizmetler/evden-eve-nakliyat-1.webp",
      "/images/hizmetler/evden-eve-nakliyat-2.webp",
      "/images/hizmetler/evden-eve-nakliyat-3.webp"
    ]
  },
  "ofis-tasima": {
    ...
    bgImage: "/images/hizmetler/ofis-tasima-banner.webp",
    ...
    images: [
      "/images/hizmetler/ofis-tasima-1.webp",
      "/images/hizmetler/ofis-tasima-2.webp",
      "/images/hizmetler/ofis-tasima-3.webp"
    ]
  },
  "arac-nakliyati": {
    ...
    bgImage: "/images/hizmetler/arac-nakliyati-banner.webp",
    ...
    images: [
      ...
      "/images/hizmetler/arac-nakliyati-2.webp",
      "/images/hizmetler/arac-nakliyati-3.webp"
    ]
  },
  "sehirler-arasi-tasima": {
    ...
    bgImage: "/images/hizmetler/sehirler-arasi-tasima-banner.webp",
    ...
    images: [
      "/images/hizmetler/sehirler-arasi-tasima-1.webp",
      "/images/hizmetler/sehirler-arasi-tasima-2.webp",
      "/images/hizmetler/sehirler-arasi-tasima-3.webp"
    ]
  },
  "parca-esya-tasima": {
    ...
    bgImage: "/images/hizmetler/parca-esya-tasima-banner.webp",
    ...
    images: [
      "/images/hizmetler/parca-esya-tasima-1.webp",
      "/images/hizmetler/parca-esya-tasima-2.webp",
      "/images/hizmetler/parca-esya-tasima-3.webp"
    ]
  },
  "esya-depolama": {
    ...
    bgImage: "/images/hizmetler/esya-depolama-banner.webp",
    ...
    images: [
      "/images/hizmetler/esya-depolama-1.webp",
      "/images/hizmetler/esya-depolama-2.webp",
      "/images/hizmetler/esya-depolama-3.webp"
    ]
  },
  "montaj-ve-demontaj": {
  ...
  "asansorlu-nakliyat": {
    ...
    intro: "Dar merdiven boşlukları, bina asansörü kullanım yasakları ve site yönetimlerinin koyduğu kısıtlamalar artık taşınma stresinin bir parçası değil. Yüksek katlı mimariler için özel olarak tasarlanmış, araca entegre mobil dış cephe asansörlerimiz sayesinde eşyalarınız doğrudan balkon veya geniş pencerelerinizden nakliye aracımıza aktarılır. Bu teknolojik sistem; insan gücünden kaynaklı yorgunluk hatalarını sıfırlar, taşınma süresini yarı yarıya kısaltır ve mobilyalarınızın merdiven köşelerine çarparak hasar görme riskini %100 oranında engeller.",
    technicalDetails: [
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-white p-8 md:p-12 rounded-3xl shadow-xl border border-gray-100">
              <div className="flex items-center gap-5 mb-8 border-b border-gray-100 pb-6">
                ...
                <h2 className="text-3xl font-black text-blue-950 tracking-tight">{service.title} Operasyon Detayları</h2>
              </div>
