        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:mt-[-100px] relative z-20">
            {[
              ...
              { icon: "🏗️", title: "Asansörlü Nakliyat", text: "Yüksek katlara ulaşabilen modüler asansör sistemleri." },
              { icon: "📦", title: "Özel Ambalaj", text: "Darbe emici malzemelerle profesyonel paketleme çözümleri." }
            ].map((feature, i) => (
              <div key={i} className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 text-center transform transition-transform hover:-translate-y-2">
                <div className="text-6xl mb-4">{feature.icon}</div>
                <h3 className="text-xl font-black text-blue-950 mb-3">{feature.title}</h3>
                <p className="text-gray-600 leading-relaxed text-sm font-medium">{feature.text}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="mb-16">
            <div className="flex items-center gap-4 mb-8">
              <div>
                ...
                <p className="text-gray-500 font-medium text-sm mt-1">Merkezi ve genişleyen alanlarıyla 25 ilçe</p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {avrupaYakasi.map((ilce) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-30 group-hover:opacity-10 transition-opacity bg-[url('https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?q=80&w=400')] bg-cover bg-center"></div>
          ...
          <div>
            <div className="flex items-center gap-4 mb-8">
              <div>
                ...
                <p className="text-gray-500 font-medium text-sm mt-1">Boğaz hattı ve geniş yerleşim bölgelerini kapsayan 14 ilçe</p>
              </div>
              <div className="flex-grow h-px bg-gray-200 hidden md:block"></div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {anadoluYakasi.map((ilce) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-30 group-hover:opacity-10 transition-opacity bg-[url('https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b?q=80&w=400')] bg-cover bg-center"></div>
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center z-10">
                    <span className="text-white font-black text-sm md:text-base tracking-wide uppercase group-hover:scale-105 transition-transform">
                      {ilce.name}
                    </span>
      ...
      <section className="bg-orange-500 py-20 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="mb-10 text-orange-100 text-lg md:text-xl max-w-2xl mx-auto font-medium">
            İstanbul'u parçalarcasına çalışıyor, Türkiye'nin her noktasına liderlik taşıyoruz.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link href="/araclar/hacim-hesaplama" className="bg-blue-950 text-white hover:bg-gray-900 px-10 py-4 rounded-full font-bold text-lg transition-all shadow-xl">
               Hacim Hesapla
             </Link>
             <a href="tel:+905322830628" className="bg-white text-orange-600 hover:bg-gray-50 px-10 py-4 rounded-full font-black text-lg transition-all shadow-xl">
               Hemen Arayın
             </a>
          </div>
        </div>
